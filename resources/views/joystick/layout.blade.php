      ...
      <div class="row">
        <div class="col-xs-7 col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar collapse in" id="sidebarContent">
            ...
            @can('viewAny', App\Models\Product::class)<li @if(Request::is($lang.'/admin/products*')) class="active" @endif><a href="/{{ $lang }}/admin/products"><i class="material-icons md-20">store</i> Объекты</a></li>@endcan
